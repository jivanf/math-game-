...
public class game extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void setQuestionAndAnswers() {
        ...
        int num1 = randInt.nextInt(50);
        num1++;

        int num2 = randInt.nextInt(50);
        num2++;

        int num3 = randInt.nextInt(50);
        num3++;

        answers = new int[3];
        answers[0] = num1 + num2 + num3;
        correctAnswer = answers[0];

        textObjectNum1.setText("" + num1);
        textObjectNum2.setText("" + num2);
        textObjectNum3.setText("" + num3);
    ...
    //decreases counter by one second.
